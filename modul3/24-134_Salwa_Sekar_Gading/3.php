...
// NOMOR 1: Menambahkan Lima Data Baru ke Array daftarTinggi
echo "<h2>Nomor 1 : Menambahkan Lima Data Baru ke Array daftarTinggi</h2>";
...
echo "<strong>Isi array daftarTinggi setelah penambahan data:</strong><br>";
...
// NOMOR 2: Menghapus Satu Data dari Array daftarTinggi
echo "<h2>Nomor 2 : Menghapus Satu Data dari Array daftarTinggi</h2>";
...
// Mencari elemen terakhir setelah penghapusan
$namaTerakhir = "";
$tinggiTerakhir = 0;
foreach ($daftarTinggi as $nama => $tinggi) {
    $namaTerakhir = $nama;
